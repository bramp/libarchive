...
#line 136 "tar/getdate.y"
    {
		/* "7:14+0700" */
		yyDSTmode = DSToff;
		yyTimezone = - ((yyvsp[(3) - (3)].Number) % 100 + ((yyvsp[(3) - (3)].Number) / 100) * 60);
	}
    break;
...
#line 148 "tar/getdate.y"
    {
		yyHour = (yyvsp[(1) - (3)].Number);
		yyMinutes = (yyvsp[(3) - (3)].Number);
		yySeconds = 0;
	}
    break;
...
#line 264 "tar/getdate.y"
    {
		/* "-3 hours" */
		yyRelSeconds -= (yyvsp[(2) - (3)].Number) * (yyvsp[(3) - (3)].Number);
	}
    break;
...
#line 280 "tar/getdate.y"
    {
		/* "-3 months" */
		yyRelMonth -= (yyvsp[(2) - (3)].Number) * (yyvsp[(3) - (3)].Number);
	}
    break;
